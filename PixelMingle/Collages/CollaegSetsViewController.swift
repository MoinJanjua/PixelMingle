//
//  CollaegSetsViewController.swift
//  PixelMingle
//
...
class CollaegSetsViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension CollaegSetsViewController {
